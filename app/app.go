...
import (
	...
	appparams "github.com/kingdotnet/bling/app/params"
	"github.com/kingdotnet/bling/x/bling"
	blingkeeper "github.com/kingdotnet/bling/x/bling/keeper"
	blingtypes "github.com/kingdotnet/bling/x/bling/types"
...
var (
	...
	DefaultNodeHome = func(appName string) string {
		return os.ExpandEnv("$HOME/.bling")
	}
...
type App struct {
	*baseapp.BaseApp
	...
	blingKeeper blingkeeper.Keeper
...
func New(
	...
	app.blingKeeper = *blingkeeper.NewKeeper(
        appCodec, keys[blingtypes.StoreKey], keys[blingtypes.MemStoreKey],
	)
	...
	app.mm = module.NewManager(
		...
		transferModule,
		bling.NewAppModule(appCodec, app.blingKeeper),
