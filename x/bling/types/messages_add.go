...
func NewMsgCreateAdd(creator string, post string, title string, body string, ipfs string, parent string) *MsgCreateAdd {
  return &MsgCreateAdd{
		Creator: creator,
    Post: post,
    Title: title,
...
func NewMsgUpdateAdd(creator string, id string, post string, title string, body string, ipfs string, parent string) *MsgUpdateAdd {
  return &MsgUpdateAdd{
        Id: id,
		Creator: creator,
    Post: post,
...
func NewMsgDeleteAdd(creator string, id string) *MsgDeleteAdd {
  return &MsgDeleteAdd{
        Id: id,
		Creator: creator,
	}
